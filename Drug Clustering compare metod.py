...
Out_final=pd.read_csv("E:/DATA/UniTese/Data/Tese 2/Implementation/Result/"+str(ModelLayer)+"/All_Result.csv",index=False,sep="\t")
...
def BinToDigit(d2,d1,d0):
    return int((d2*pow(2,2))+(d1*pow(2,1))+(d0*pow(2,0)))
...
for i in range(Out.shape[0]):
    Out.at[i,'PredictClass']=BinToDigit(Out.at[i,0],Out.at[i,1],Out.at[i,2])

Out['Class']  = Out['Class'].astype('int')
Out['PredictClass']  = Out['PredictClass'].astype('int')


Out.to_csv("H:/Uni Tese/Tese 2/Implementation/Result/"+str(ModelLayer)+"/All_Result.csv",index=False,sep="\t")



# #-------- Save Model --------------------
# import  pickle
# f=open("H:/Uni Tese/Tese 2/Implementation/Result/"+str(ModelLayer)+"/Weight_Chemical_Hormonizome Macc Shape"+str(Macc.shape)+" Hormonizome Shape : "+str(Hormonizom.shape)+"_epoch "+str(p_epoch[0])+"_lr "+str(p_lr[3])+"_batch"+str(p_batchsize[1])+"_CD "+str(cdk[0])+"_CdkDaynamic "+str(CdkDaynamic[0])+".file", "wb")
# pickle.dump(Weight, f)
# f=open("H:/Uni Tese/Tese 2/Implementation/Result/"+str(ModelLayer)+"/HiddenBias_Chemical_Hormonizome Hormonizome Shape"+str(Macc.shape)+"Hormonizome Shape : "+str(Hormonizom.shape)+"_epoch "+str(p_epoch[0])+"_lr "+str(p_lr[3])+"_batch"+str(p_batchsize[1])+"_CD "+str(cdk[0])+"_CdkDaynamic "+str(CdkDaynamic[0])+".file", "wb")
# pickle.dump(HiddenBiase, f)



############ Compare and Compute Sillohet Score(MACC with 20974)  ##############
Out=pd.read_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Clustering By Only Chemical/WithDuplicate/All_Result.csv',delimiter="\t")
kmeans_model = KMeans(n_clusters=15, random_state=1).fit(Macc.iloc[:,2:])
labels = kmeans_model.labels_
metrics.silhouette_score(Macc.iloc[:,2:], labels, metric='euclidean')
#result is : 0.09

metrics.silhouette_score(Macc.iloc[:,2:], Out['PredictClass'], metric='euclidean')
#result is : -0.07

############ Compare and Compute Sillohet Score(MACC with 3712)  ##############
kmeans_model = KMeans(n_clusters=4, random_state=1).fit(Macc.iloc[:,2:])
labels = kmeans_model.labels_
metrics.silhouette_score( Macc.iloc[:,2:] , labels, metric='euclidean')
#result is : 0.10

Out=pd.read_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Clustering By Only Chemical/WithoutDuplicate/All_Result.csv',delimiter="\t")
metrics.silhouette_score(Macc.iloc[:,2:], Out['PredictClass'], metric='euclidean')
#result is : -0.09

########### Compare and Compute Sillhote Score(Hormonizome with 29074) ###############
kmeans_model = KMeans(n_clusters=4, random_state=1).fit(Hormonizom.iloc[:,4:])
labels = kmeans_model.labels_
metrics.silhouette_score( Hormonizom.iloc[:,4:] , labels, metric='euclidean')
#result is : 0.08
metrics.silhouette_score(Hormonizom.iloc[:,4:], Out['PredictClass'], metric='euclidean')
#result is : -0.002


########### Compare and Compute Sillhote Score(Chemical+Hormonizome without Concatenation Feature ) ############### 
Out=pd.read_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/Out_L4.csv',delimiter="\t")
AllData=pd.concat([Macc.iloc[:,2:],Hormonizom.iloc[:,4:]],axis=1)
kmeans_model = KMeans(n_clusters=12, random_state=1).fit(AllData.iloc[:,2:])
labels = kmeans_model.labels_
metrics.silhouette_score( AllData.iloc[:,2:] , labels, metric='cityblocke')
#result is : -0.007
metrics.silhouette_score(AllData.iloc[:,2:], Out['PredictClass'], metric='cityblock',n_jobs=10 )
#result is : -0.01


########### Compare and Compute Sillhote Score(Chemical+Hormonizome With Concatenation Feature ) ############### 
Out=pd.read_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Clustering By Only Concatenate Chemical_Gene/All_Result.csv',delimiter="\t")
AllData=pd.concat([Macc.iloc[:,2:],Hormonizom.iloc[:,4:]],axis=1)
kmeans_model = KMeans(n_clusters=2, random_state=1).fit(AllData.iloc[:,2:])
labels = kmeans_model.labels_
metrics.silhouette_score( AllData.iloc[:,2:] , labels, metric='euclidean')
#result is : 0.17
metrics.silhouette_score(AllData.iloc[:,2:], Out['PredictClass'], metric='euclidean')
#result is : 0.0002

###################### Compare and Compute NMI and ADNMI Score(MACC with 3712) #################
Out=pd.read_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Clustering By Only Chemical/WithoutDuplicate/All_Result.csv',delimiter="\t")
MaccWithoutNoClass=Macc[Macc.Class!='NoClass']
OutWithoutNoClass=Out[Out.CID.isin(MaccWithoutNoClass.CID)].dropna()
normalized_mutual_info_score(MaccWithoutNoClass.Class,OutWithoutNoClass.PredictClass)
# NMI result is : 0.048

###################### Compare and Compute NMI and ADNMI Score(Hormonizome with 29074) #################
Out=pd.read_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Clustering By Only Gene/All_Result.csv',delimiter="\t")
HormonizomWithoutNoClass=Hormonizom[Hormonizom.Class!='NoClass'].reset_index(drop=True)
OutWithoutNoClass=Out[Out.CID.isin(HormonizomWithoutNoClass.CID)].dropna()
normalized_mutual_info_score(HormonizomWithoutNoClass.Class,OutWithoutNoClass.PredictClass)
# NMI result is : 0.002

# ###################### Compare and Compute NMI and ADNMI Score(Hormonizome with 3597) Only MCF7 #################
# Out=pd.read_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Clustering By Only Gene/Only Mcf7/All_Result.csv',delimiter="\t")
# HormonizomWithoutNoClass=Hormonizom[Hormonizom.Class!='NoClass'].reset_index(drop=True)
# OutWithoutNoClass=Out[Out.CID.isin(HormonizomWithoutNoClass.CID)].dropna()
# normalized_mutual_info_score(HormonizomWithoutNoClass.Class,OutWithoutNoClass.PredictClass)
# # NMI result is : 0.02
...
####################### Compare and Compute NMI and ADNMI Score(Hormonizome+Chemical with Concatenate) #################
...
AllDataWithoutNoClass=AllData[AllData.Class!='NoClass'].reset_index(drop=True)
OutWithoutNoClass=Out[Out.CID.isin(AllDataWithoutNoClass.CID)].dropna()

normalized_mutual_info_score(AllDataWithoutNoClass.Class,OutWithoutNoClass.PredictClass)
# NMI result is : 0.001
metrics.silhouette_score( AllData.iloc[:,2:] , Out.PredictClass, metric='euclidean')
#Result is with NoClass : 0.0002
#Result is withOut NoClass : -0.0008

####################### Compare and Compute NMI and ADNMI Score(Hormonizome+Chemical withOut Concatenate) #################
Out=pd.read_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/Out_L4.csv',delimiter="\t")
kmeans_model = KMeans(n_clusters=12, random_state=1).fit(AllData.iloc[:,2:])
labels = kmeans_model.labels_
metrics.silhouette_score( AllData.iloc[:,2:] , labels, metric='euclidean')
# silhouette without NoClass result is : -0.007
normalized_mutual_info_score(AllData.Class,labels)
# NMI with NoClass result is : 0.04


AllDataWithoutNoClass=AllData[AllData.Class!='NoClass'].reset_index(drop=True)
OutWithoutNoClass=Out[Out.CID.isin(AllDataWithoutNoClass.CID)].dropna()
normalized_mutual_info_score(AllDataWithoutNoClass.Class,OutWithoutNoClass.PredictClass)
# NMI without NoClass result is : 0.007
# NMI with NoClass result is : 0.002
metrics.homogeneity_score(AllDataWithoutNoClass.Class,OutWithoutNoClass.PredictClass)
#homogeneity without NoClass is : 0.008
#homogeneity with NoClass is : 0.003
metrics.completeness_score(AllDataWithoutNoClass.Class,OutWithoutNoClass.PredictClass)
# completeness without NoClass result is : 0.007
metrics.v_measure_score(AllDataWithoutNoClass.Class,OutWithoutNoClass.PredictClass)
# v_measure_score without NoClass result is : 0.007

################ MACC+Hormonizome (with Concat) Drug Pathway and specific Gene ##############
#############################################################################################
labels=pd.read_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/Clustering By Only Concatenate Chemical_Gene/All_Result.csv',delimiter="\t")
AllDrugPathByCluster=pd.DataFrame(columns=All_Drug_Path.columns)
AllDrugPathByCluster.insert(0,'Cluster',np.NaN)
for DrugPathCid in All_Drug_Path['CID'].drop_duplicates().reset_index(drop=True):
    AllCluster=pd.DataFrame(labels[labels.CID==DrugPathCid].PredictClass).drop_duplicates().reset_index(drop=True)
    for Cluster in AllCluster.PredictClass:
        AllDrugPathByCluster=AllDrugPathByCluster.append(All_Drug_Path[All_Drug_Path.CID==DrugPathCid].reset_index(drop=True),ignore_index=True)
...
count=0
AllDrugPath_Gene=pd.DataFrame(columns=['CID','Cluster','DrugName','Gene','PathwayCode','PathwayName'])
for row in AllDrugPathByCluster.index:
    ...
    for Gene in GeneList:
        ...
        AllDrugPath_Gene.at[i,'PathwayName']=AllDrugPathByCluster.at[row,'PathwayName']
...
############################################
kmeans_model = KMeans(n_clusters=12, random_state=1).fit(AllData.iloc[:,2:])
labels = pd.DataFrame(kmeans_model.labels_,columns=['PredictedClass'])
labels.insert(0,'Class',AllData.Class)
labels.insert(0,'CID',AllData.CID)
labels.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/K-Means.csv',index=False,sep="\t")
labels=labels.drop_duplicates()
################ DrugPath for K-Means #################
AllDrugPathByCluster=pd.DataFrame(columns=All_Drug_Path.columns)
AllDrugPathByCluster.insert(0,'Cluster',np.NaN)
for DrugPathCid in All_Drug_Path['CID'].drop_duplicates().reset_index(drop=True):
    AllCluster=pd.DataFrame(labels[labels.CID==DrugPathCid].PredictedClass).drop_duplicates().reset_index(drop=True)
    for Cluster in AllCluster.PredictedClass:
        AllDrugPathByCluster=AllDrugPathByCluster.append(All_Drug_Path[All_Drug_Path.CID==DrugPathCid].reset_index(drop=True),ignore_index=True)
        AllDrugPathByCluster=AllDrugPathByCluster.fillna(Cluster)

AllDrugPathByCluster.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/K-Means_Drug_Pathway',index=False,sep="\t")
...
for row in AllDrugPathByCluster.index:
    ...
    for Gene in GeneList:
        ...
        AllDrugPath_Gene.at[i,'PathwayName']=AllDrugPathByCluster.at[row,'PathwayName']
        AllDrugPath_Gene.at[i,'Gene']=Gene
AllDrugPath_Gene.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllDrugPathInEvenCluster.csv',index=False,sep="\t")
...
ax.set_ylim(12, 0.1)
########### Specific Gene ###############
AllDrugPath_Gene[AllDrugPath_Gene.Cluster==1].Gene.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllDrugPathInEvenCluster_Cluster1.csv',sep="\t",index=False)
AllDrugPath_Gene[AllDrugPath_Gene.Cluster==2].Gene.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllDrugPathInEvenCluster_Cluster2.csv',sep="\t",index=False)
AllDrugPath_Gene[AllDrugPath_Gene.Cluster==3].Gene.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllDrugPathInEvenCluster_Cluster3.csv',sep="\t",index=False)
AllDrugPath_Gene[AllDrugPath_Gene.Cluster==4].Gene.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllDrugPathInEvenCluster_Cluster4.csv',sep="\t",index=False)
AllDrugPath_Gene[AllDrugPath_Gene.Cluster==5].Gene.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllDrugPathInEvenCluster_Cluster5.csv',sep="\t",index=False)
AllDrugPath_Gene[AllDrugPath_Gene.Cluster==6].Gene.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllDrugPathInEvenCluster_Cluster6.csv',sep="\t",index=False)
AllDrugPath_Gene[AllDrugPath_Gene.Cluster==7].Gene.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllDrugPathInEvenCluster_Cluster7.csv',sep="\t",index=False)
AllDrugPath_Gene[AllDrugPath_Gene.Cluster==8].Gene.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllDrugPathInEvenCluster_Cluster8.csv',sep="\t",index=False)
AllDrugPath_Gene[AllDrugPath_Gene.Cluster==9].Gene.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllDrugPathInEvenCluster_Cluster9.csv',sep="\t",index=False)
AllDrugPath_Gene[AllDrugPath_Gene.Cluster==10].Gene.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllDrugPathInEvenCluster_Cluster10.csv',sep="\t",index=False)
AllDrugPath_Gene[AllDrugPath_Gene.Cluster==11].Gene.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllDrugPathInEvenCluster_Cluster11.csv',sep="\t",index=False)
AllDrugPath_Gene[AllDrugPath_Gene.Cluster==12].Gene.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllDrugPathInEvenCluster_Cluster12.csv',sep="\t",index=False)
...
AllDiff.to_csv('H:/Uni Tese/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/New Result/Q4/K-Means/AllGene_Specefic_In_All_Cluster.csv',sep="\t",index=False)
AllDiff.groupby('Cluster').count()

################# Dont NEED NOW ########################
########################################################

ModelLayerForPredictClass="/Users/aghil/Desktop/uni/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final"
...
for DrugPathCid in AllDrugPath['CID'].drop_duplicates().reset_index(drop=True):
    AllCluster=pd.DataFrame(L4[L4.CID==DrugPathCid].PredictClass).drop_duplicates().reset_index(drop=True)
    for Cluster in AllCluster.PredictClass:
...
AllDrugPath_Gene.to_csv('/Users/aghil/Desktop/uni/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/AllDrugPathInEvenCluster.csv',sep="\t",index=False)

### distribution Pathway in even cluster
AllDrugPath_Gene=pd.read_csv('/Users/aghil/Desktop/uni/Tese 2/Implementation/Result/Hormonizom_Chemical/solution_final/AllDrugPathInEvenCluster.csv',delimiter="\t")
#By 5 Cluster
